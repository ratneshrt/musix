                ...
                <div className="flex justify-center">
                    <div className="px-10">
                        <div className="py-3">
                            ...
                            <div className="flex items-center h-auto bg-black mt-4">
                                <div className="bg-black rounded-full pt-3 shadow-lg">
                                    <button onClick={handleSignIn} className="flex items-center bg-white rounded-full shadow-md px-6 py-2 text-sm font-medium text-gray-800  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                        ...
                                        <span>Embrace Your Destiny</span>
                                    </button>
                                </div>
                            </div>
                        </div>
